...
AXI address decoding, routing and response selection

axi_ram.v

AXI-connected program/data RAM

axi_uart.v

Memory-mapped AXI UART interface
...
Open-source PicoRV32 RISC-V CPU core
